  ...
  switch (action.type) {
    case 'BOOTSTRAP':
      if (action.profile) {
        if (!state.profile.reservations) {
          return { ...state, profile: { ...action.profile, reservations: [] } };
        }
    ...
    case 'FETCH_RESERVATIONS_SUCCESS':
      return {
        ...state,
        loading: false,
        profile: { ...state.profile, reservations: action.reservations },
      };
    ...
    case 'LOGOUT':
      return {
        ...state,
        loading: false,
        profile: { ...state.profile, user: null, reservations: [] },
      };
    case 'CATEGORIES_LOADED':
      return {
        ...state,
        loading: false,
        profile: { ...state.profile, categories: action.categories },
      };
    case 'DAY_FILTER':
    ...
    case 'NOTIFICATION_RECEIVED':
      return Object.assign({}, state,
        { notificationModalVisible: true, notification: action.notification });
